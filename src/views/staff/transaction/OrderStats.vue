        ...
        <el-table :data="dataAll">
            ...
            <el-table-column fixed="right" label="Hành động" width="200">
                <template #default="scope">
                    <div>
                        <el-button type="success" size="small" plain :disabled="scope.row.status !== 'Đang xử lý'"
                            >Thành công</el-button
                        >
                        <el-button type="danger" size="small" plain :disabled="scope.row.status !== 'Đang xử lý'"
                            >Thất bại</el-button
                        >
                    </div>
                </template>
...
const dataAll = [...dataSend, ...dataReceive];
